...
app.post("/api/riformula", async (req, res) => {
  ...
  try {
    ...
    if (trimmedInput.length > 500) {
      return res.status(400).json({ error: "Descrizione troppo lunga. Massimo 500 caratteri" });
    }

    // Preprocess input con validatore (solo correzioni, no validazione semantica)
